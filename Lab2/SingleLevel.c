...
void main()
{
 ...
 /* The strcmp() function takes two strings and return an integer. 0->identical */

 /* The strcpy() function copies the string to the another
character array. strcpy(destination, source) */